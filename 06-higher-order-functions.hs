...
--          sumInts 1 3 = 6
sumInts :: Int -> Int -> Int
sumInts a b = foldl1 (\acc x-> acc +x) [a..b]
-- sumInts a b
--     |a==b       = a
...
higherOrderSum intApplication a b = foldl (\acc x->acc + intApplication x) 0 [a..b]
...
higherOrderSequenceApplication op f base a b = foldl f base $ map op [a..b]
-- this seriously need an Example
